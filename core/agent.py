...
def analyze_portfolio_risk(positions: list, span_results: dict) -> str:
    ...
    prompt = f'''You are a senior risk manager at a hedge fund. Analyze this portfolio and provide a concise risk narrative.
...
2. Top 3 risk concentrations
3. Margin efficiency observations (spread credits helping?)
4. One actionable recommendation

Be concise and professional. Use numbers where relevant.'''
